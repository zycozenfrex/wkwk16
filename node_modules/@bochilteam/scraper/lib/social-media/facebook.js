...
const crypto_1 = require("../encryptions/crypto");
...
async function facebookdl(url) {
    ...
    const { data: { id, thumbnail, duration, a, av, v }, } = await (0, got_1.default)(`https://youtube4kdownloader.com/ajax/getLinks.php`, {
        ...
        searchParams: {
            video: url,
            rand: (0, crypto_1.randomBytes)(13),
        },
    }).json();
    const result = a
        .concat(av)
...
async function facebookdlv2(url) {
    ...
    const res = await got_1.default
        ...
        .json();
    if (res.error)
        throw new utils_1.ScraperError(JSON.stringify(res));
    let result = [];
    ...
    if (!result.length)
        throw new utils_1.ScraperError(`Can't download!\n${$.html()}`);
    return {
        id: (_b = (_a = $("div.media-content > div.content > p > strong")
            .text()
            .split("#")) === null || _a === void 0 ? void 0 : _a[1]) === null || _b === void 0 ? void 0 : _b.trim(),
